    ...
    <nav class="top-navbar navbar navbar-default navbar-static-top" role="navigation" id="navbar">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-logo pull-left" ui-sref="dashboard">
                <img src="http://manticore.com.co/images/logo.jpg" alt="MantiCore logo">
            </a>
        ...
        <div class="sidebar-nav navbar-collapse" ng-class="{collapse: isCollapsed}">
            <div class="sidebar_links">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li ng-class="{active: mainUrl == 'people'}">
                        <a ui-sref="people" ng-click="isCollapsed = !isCollapsed">
                            <i class="material-icons">nature_people</i>
                            People Counter
                        </a>
                    </li>
                    <li ng-class="{active: mainUrl == 'reports'}">
                        <a ui-sref="reports" ng-click="isCollapsed = !isCollapsed">
                            <i class="material-icons">insert_chart</i>
                            Reportes
                        </a>
                    </li>
                    <li ng-class="{active: mainUrl == 'site'}">
                        <a ui-sref="site" ng-click="isCollapsed = !isCollapsed" href="http://manticore.com.co/" target="_blank">
